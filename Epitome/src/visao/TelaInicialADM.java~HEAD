...
public class TelaInicialADM extends JFrame {
	...
	private static TelaInicialADM frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new TelaInicialADM(usuario);
	...
	private static void panelChisel(JPanel panel, Color color, int radius) {
		...
		RoundedBorder LineBorder = new RoundedBorder(color, radius);
		Border emptyBorder = BorderFactory.createEmptyBorder(panel.getBorder().getBorderInsets(panel).top,
				panel.getBorder().getBorderInsets(panel).left, panel.getBorder().getBorderInsets(panel).bottom,
				panel.getBorder().getBorderInsets(panel).right);
