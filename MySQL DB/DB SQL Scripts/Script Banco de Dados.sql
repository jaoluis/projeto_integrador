...
CREATE TABLE IF NOT EXISTS `mydb`.`Preco` (
  ...
  INDEX `fk_id_produto_preco_idx` (`fk_id_historico_produto_preco` ASC),
  CONSTRAINT `fk_id_produto_preco`
    FOREIGN KEY (`fk_id_historico_produto_preco`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Relacao_Fornecedor_Produto` (
  ...
  INDEX `fk_id_fornecedor_produto_fornecedor_idx` (`fk_id_fornecedor` ASC),
  INDEX `fk_id_produto_fornecedor_produto_idx` (`fk_id_historico_produto` ASC),
  CONSTRAINT `fk_id_fornecedor_produto_fornecedor`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Controle_Entrada` (
  ...
  INDEX `fk_id_produto_entrada_idx` (`fk_id_historico_produto_entrada` ASC),
  CONSTRAINT `fk_id_produto_entrada`
    FOREIGN KEY (`fk_id_historico_produto_entrada`)
    REFERENCES `mydb`.`Historico_Produto` (`id_historico_produto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fornecedor_Contato` (
  ...
  INDEX `fk_id_fornecedor_contato_idx` (`fk_id_fornecedor` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fornecedor_Endereco` (
  ...
  INDEX `fk_id_fornecedor_endereco_idx` (`fk_id_fornecedor` ASC),
  CONSTRAINT `fk_id_fornecedor_endereco`
    FOREIGN KEY (`fk_id_fornecedor`)
    REFERENCES `mydb`.`Fornecedor` (`id_fornecedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Venda` (
  ...
  INDEX `fk_id_usuario_venda_idx` (`fk_id_usuario_venda` ASC),
  CONSTRAINT `fk_id_usuario_venda`
    FOREIGN KEY (`fk_id_usuario_venda`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario_Contato` (
  ...
  INDEX `fk_id_usuario_contato_idx` (`fk_id_usuario_contato` ASC),
  CONSTRAINT `fk_id_usuario_contato`
    FOREIGN KEY (`fk_id_usuario_contato`)
    REFERENCES `mydb`.`Usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario_Endereco` (
  ...
  INDEX `fk_id_usuario_endereco_idx` (`fk_id_usuario_endereco` ASC),
  CONSTRAINT `fk_id_usuario_endereco`
    FOREIGN KEY (`fk_id_usuario_endereco`)
    REFERENCES `mydb`.`Usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
